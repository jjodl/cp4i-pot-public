...
1. If necessary, change the value for TARGET_NAMESPACE to your project name. Click the hamburger menu in top right corner and select *Find and Replace*.  **Note:** for the Storage class use **ocs-storagecluster-ceph-rbd**
